...
def graph_based(data,k,m,edges,idx,qrank,maxMST): 
	minsize=20
   	n=len(edges)
   	count=0
   	for i in range(0,n):
...
def graph_based_seg(data,minsize,k,sigma):
	...
	#print "give k"
	#k=input()
	data=graph_based(data,k,m,edges,idx,qrank,maxMST)#segmentating
